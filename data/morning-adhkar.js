/**
 * أذكار الصباح — GENERATED by scripts/fetch-adhkar.js from the
...
window.MorningAdhkar = [
  ...
  },
  {
    ...
    "remaining": 100,
    "category": "صباح",
    "fadl": "من قالها 100 مرة في يوم كانت له عدل عشر رقاب، وكتبت له مئة حسنة، ومحيت عنه مئة سيئة، وكانت له حرزا من الشيطان في يومه ذلك حتى يمسي ولم يأتي أحد بأفضل مما جاء به إلا احد عمل أكثر من ذلك",
    "source": "الترمذي"
  },
  {
    "id": 30,
